...
for i = 1:iterations
    ...
    testy = y(1:500,:);
    w1 = mldivide(train'*train,train')*trainy;
    mean_training = meansquares(train,trainy,w1,msize);
    mean_test = meansquares(test,testy,w1,msize);
    
    train10 = X(501:510,:);
    train10y = y(501:510,:);
    
    w10 = mldivide(train10'*train10,train10')*train10y;
    mean_train10 = meansquares(train10,train10y,w10,msize)
    mean_test10 = meansquares(test,testy,w10,msize)
